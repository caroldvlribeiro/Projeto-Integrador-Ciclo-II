        ...
        <div class="app">
                <header class="header">
                        <a href="Dashboard.php" class="logo">
                                <svg width="36" height="36" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="2" y="2" width="52" height="52" fill="none" stroke="#EFF2F4"
                                                stroke-width="1.5" />
                                        <rect x="12" y="12" width="52" height="52" fill="none" stroke="#EFF2F4"
                                                stroke-width="1.5" />
                                        <rect x="22" y="22" width="52" height="52" fill="none" stroke="#EFF2F4"
                                                stroke-width="1.5" />
                        ...
                        <div class="header-user-group">
                                ...
                                <a href="?acao=logout" class="btn-logout">
                ...
                <aside class="sidebar">
                        ...
                        <a href="Orcamentos.php"
                                class="nav-item <?= $paginaAtiva === 'orcamentos' ? 'active' : '' ?>"><i
                                        class="ti ti-file-text"></i> Orçamentos</a>
                        <a href="NovoOrcamento.php"
                                class="nav-item <?= $paginaAtiva === 'novoorcamento' ? 'active' : '' ?>"><i
                        ...
                        <a href="MovimentacoesEstoque.php"
                                class="nav-item <?= $paginaAtiva === 'movimentacoesestoque' ? 'active' : '' ?>"><i
                        ...
                        <a href="Categorias.php"
                                class="nav-item <?= $paginaAtiva === 'categorias' ? 'active' : '' ?>"><i
